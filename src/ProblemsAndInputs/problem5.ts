...
function problem5a()
{
    ...
    computer.runProgram();
    console.log( `Problem 5a answer = ${mockStdOut.outputs.slice( -1 )}` );
}
...
function problem5b()
{
    ...
    computer.loadProgram( testDiagnosticProgram );
    computer.runProgram();
    console.log( `Problem 5b answer = ${mockStdOut.outputs.slice( -1 )}` );
}
